...
<script>
    ...
    function ajax_cadastrar_anotacao(){
        ...
        var frm_pp_sn = document.getElementById('pp_sn').value;
        var frm_con_desc = document.getElementById('con_desc').value;
        var frm_ip_sn = document.getElementById('ip_sn').value;
        var frm_ip_desc = document.getElementById('ip_desc').value;
        $.ajax({
                    ...
                    data: {
                        ...
                        frm_pp_sn: frm_pp_sn,
                        frm_con_desc: frm_con_desc,
                        frm_ip_sn: frm_ip_sn,
                        frm_ip_desc: frm_ip_desc
