<?php
    if($var_atd != ''){
        $consulta_info_ger ="SELECT atd.CD_ATENDIMENTO,
                                    pac.CD_PACIENTE, 
                                    pac.NM_PACIENTE, 
        ...
        $consulta_info_ger ="SELECT pac.CD_PACIENTE,
                                    pac.NM_PACIENTE,
                                    TO_CHAR(pac.DT_NASCIMENTO, 'DD/MM/YYYY') AS NASCIMENTO,
                                    FLOOR((SYSDATE - pac.DT_NASCIMENTO) / 365.242199) AS IDADE 
                                    FROM  dbamv.PACIENTE pac
                                    WHERE pac.CD_PACIENTE = $id ";
    }
...
<div class='row'>
    ...
    <div class='col-md-4' style='text-align:left'>
        ...
        Convenio:
        <input class='form-control' name='frm_idade' type='text' value="<?php if($var_atd == null){ echo 'Paciente sem atendimento'; }else{ echo @$row_info['NM_CONVENIO']; } ?>" readonly> 
