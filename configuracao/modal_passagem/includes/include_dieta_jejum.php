...
<div class='col-md-12' style='text-align:left'>
    ...
    Dieta/Jejum:
    <textarea class='textarea' style="width: 100%;" name='frm_dienta_jejum' readonly><?php 
    if($var_atd == null){ 
        echo 'Paciente sem atendimento'; 
    }else{
        while (@$row_dieta = oci_fetch_array($result_consulta_dieta)){
